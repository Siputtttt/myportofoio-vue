            ...
            <div class="relative flex h-16 items-center justify-between">
                ...
                <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                    ...
                    <Menu as="div" class="relative ml-3">
                        <div>
                            <p class="text-2xl font-medium text-white font-bold">Siputt</p>
                            <!-- <MenuButton
                                class="relative flex rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
                                <span class="absolute -inset-1.5" />
                                <span class="sr-only">Open user menu</span>
                                <img class="h-8 w-8 rounded-full" src="../assets/image/profile.png" alt="" />
                            </MenuButton> -->
                        </div>
...
import Profile from '../components/information/Profile.vue'
import About from '../components/information/About.vue'
import Technology from '../components/information/Technology.vue'
import PortofolioVue from '../components/information/Portofolio.vue'
import Contact from '../components/information/Contact.vue'
import Footer from '../components/information/Footer.vue'
